...
(function($) {
    ...
    var NivoSlider = function(element, options){
        ...
        //Create title     
        slider.append($('<div class="nivo-title"><p></p></div>').css({display:'none',opacity:settings.captionOpacity}));
        //Create caption
        slider.append(
        ...
        $('.nivo-title', slider).css('opacity',0);
		
                //Process title function
                var processTitle = function(settings){
			var nivoCaption = $('.nivo-title', slider);
